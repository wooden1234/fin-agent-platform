...
from app.agents.components.finance_agent.planner.eval_cases import (  # noqa: E402
    DEFAULT_EVAL_PATH,
    load_eval_cases,
    score_case,
    summarize,
...
async def _run_live(cases: list[dict]) -> list[dict]:
    ...
    from app.agents.components.finance_agent.planner.node import supervisor_node
