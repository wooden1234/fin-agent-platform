...
COMPANY_OVERRIDE_RECORDS: tuple[CompanyMetricOverride, ...] = tuple(
    CompanyMetricOverride(
        company_key=company_key,
        canonical_metric_code=canonical_code,
        metric_name=metric_name,
    )
    for company_key, overrides in COMPANY_OVERRIDES.items()
    for canonical_code, metric_names in overrides.items()
